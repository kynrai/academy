---
title: "Day 5 – Multi-Agent Coordination"
---
...
## Reading / Reference
- [Anthropic: Multi-agent systems](https://platform.claude.com/docs/en/managed-agents/multi-agent) — orchestration and sub-agent patterns.
