---
title: "Day 2 – Multi-Step Reasoning Pipeline"
---
...
- Anthropic docs: [Messages API reference](https://platform.claude.com/docs/en/api/messages) — `stop_reason` values and message structure.
