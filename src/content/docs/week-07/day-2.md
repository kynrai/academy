---
title: "Day 2 – HTTP Clients: Making Network Requests"
---
...
> Note: `requests` is in maintenance mode. For new projects, `httpx` is the modern choice — similar ergonomics, with both sync and async support.
