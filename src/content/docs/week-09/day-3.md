---
title: "Day 3 – Deploy Containers to ECS"
---
...
## Tasks
- Push your Docker image from Week 8 to ECR (Elastic Container Registry) or GCR: create the registry with Terraform (`aws_ecr_repository`), authenticate Docker with `aws ecr get-login-password | docker login`, tag your image with the registry URI, and push.
