---
title: "Day 1 – Cloud Primitives and Terraform"
---
...
- Inspect `terraform.tfstate`: find your VPC resource and its attributes. Understand why this file must be stored remotely (S3 with native lockfile) in a team environment — add a `backend` block to your config but comment it out for now.
