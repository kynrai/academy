---
title: "Day 5 – Infrastructure Reproducibility"
---
...
- Write a `RUNBOOK.md` documenting: prerequisites (AWS credentials, Terraform version, AWS provider pinned to `~> 6.0`, Docker), the exact commands to bootstrap from zero, the commands to deploy a new image version, and the commands to destroy everything. Have a classmate follow your runbook on their machine.
