---
title: "Day 5 – Redis: Key-Value Stores and Choosing the Right Database"
---
...
Note: Redis relicensed to AGPLv3 starting with Redis 8 (2025), which led to Valkey — a BSD-licensed, wire-compatible fork now shipped by many distributions; the examples below are unaffected and run identically against either.
